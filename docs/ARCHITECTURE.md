...
>
> Само решение «гексагональная архитектура + Dependency Rule» зафиксировано в
> [ADR-007](adr/ADR-007-hexagonal-dependency-rule.md). Реестр всех архитектурных
> решений — в [adr/](adr/README.md).
