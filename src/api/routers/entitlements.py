...
Раскатка: по умолчанию ENTITLEMENTS_DEFAULT_TIER=free — enforcement включён,
серверы без подписки на Free (лимиты клампятся, Premium-модули закрыты), а
выданная здесь подписка открывает их на срок. Значение "pro" — временный
рубильник, отключающий платность (все получают максимум)."""
