...
class Settings(BaseSettings):
    ...
    # enforcement ВКЛючён: серверы без подписки получают Free и их лимиты
    # клампятся (Premium-модули начнут гейтиться, когда require_tier навесят на
    # коги). Выданные вручную в панели подписки работают до своего срока.
