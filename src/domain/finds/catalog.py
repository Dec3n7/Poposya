...
ITEMS: tuple[Item, ...] = (
    ...
    Item(
        ...
        Rarity.COMMON,
        "чернила поплыли, но «скучаю» ещё читается",
        emoji="💌",
    ),
    Item(
        "hibiki_mini",
        "Пустая миниатюра Hibiki",
        Rarity.COMMON,
        "кто-то пил хороший виски в плохом месте",
        emoji="🥃",
    ),
    Item(
        "hair_ribbon",
        ...
        Rarity.COMMON,
        "когда-то была алой. Токио выпил цвет",
        emoji="🎀",
    ),
    Item(
        "train_ticket",
        ...
        Rarity.COMMON,
        "в один конец, до станции, которой больше нет",
        emoji="🎫",
    ),
    Item(
        "cat_badge",
        "Ржавый значок с кошкой",
        Rarity.COMMON,
        "кошка смотрит осуждающе. Уважаю",
        emoji="🐱",
    ),
    Item(
        "shrine_candle",
        "Огарок свечи из храма",
        Rarity.COMMON,
        "догорела ровно наполовину и погасла сама",
        emoji="🕯️",
    ),
    Item(
        "ramune_marble",
        "Стеклянный шарик из бутылки рамунэ",
        Rarity.COMMON,
        "лето, запертое в стекле",
        season="лето",
        emoji="🔮",
    ),
    Item(
        "maple_leaf",
        "Кленовый лист, прижатый камнем",
        Rarity.COMMON,
        "кто-то оставил его сушиться и не вернулся",
        season="осень",
        emoji="🍁",
    ),
    # --- необычные (10) ---
    Item(
        "film_photo",
        "Плёночная фотография: силуэт под дождём",
        Rarity.UNCOMMON,
        "девушка с зонтом, лица не разглядеть. Может, и к лучшему",
        emoji="🖼️",
    ),
    Item(
        "butterfly_pin",
        ...
        Rarity.UNCOMMON,
        "одно крыло погнуто. Летала, пока могла",
        emoji="🦋",
    ),
    Item(
        "notebook_jp",
        "Записная книжка с японскими записями",
        Rarity.UNCOMMON,
        "последняя запись: «завтра обязательно скажу». Дальше пусто",
        emoji="📓",
    ),
    Item(
        "gashapon_rare",
        "Фигурка из гашапона — редкий персонаж",
        Rarity.UNCOMMON,
        "тот самый, ради которого крутят по двадцать раз",
        emoji="🧸",
    ),
    Item(
        "night_cassette",
        "Кассета «для ночных поездок»",
        Rarity.UNCOMMON,
        "подписана от руки. Сторона B стёрта почти в ноль",
        emoji="📼",
    ),
    Item(
        "furin_bell",
        "Латунный колокольчик фурин",
        Rarity.UNCOMMON,
        "звенит, даже когда ветра нет",
        season="лето",
        emoji="🎐",
    ),
    Item(
        "cinema_ticket",
        "Билет в кино, 2003 год",
        Rarity.UNCOMMON,
        "сеанс 23:40, место 13. Фильм давно забыли, билет — нет",
        emoji="🎟️",
    ),
    Item(
        "cracked_mirror",
        "Карманное зеркальце с трещиной",
        Rarity.UNCOMMON,
        "трещина ровно посередине. Отражение всё равно честное",
        emoji="🪞",
    ),
    Item(
        "arcade_stickers",
        "Наклейки из старого аркадного зала",
        Rarity.UNCOMMON,
        "зал закрылся, а очки на автомате так и висят",
        emoji="🕹️",
    ),
    Item(
        "haiku_page",
        "Вырванная страница с хайку про осень",
        Rarity.UNCOMMON,
        "почерк торопливый, будто дописывали на ходу",
        season="осень",
        emoji="📜",
    ),
    # --- редкие (6) ---
    Item(
        "film_roll",
        "Почти целая плёнка, 12 кадров",
        Rarity.RARE,
        "не проявлена. Двенадцать чужих моментов в кассете",
        emoji="🎞️",
    ),
    Item(
        "zippo_engraved",
        "Зажигалка Zippo с гравировкой",
        Rarity.RARE,
        "«не гасни» — выбито изнутри крышки",
        emoji="🔥",
    ),
    Item(
        "murakami_notes",
        ...
        Rarity.RARE,
        "читатель спорил с автором. Иногда — выигрывал",
        season="осень",
        emoji="📖",
    ),
    Item(
        ...
        "Платок с вышивкой",
        Rarity.RARE,
        "инициалы «М. К.» и ветка сакуры. Ручная работа",
        emoji="🧵",
    ),
    Item(
        "shibuya_polaroid",
        "Полароид ночного Shibuya",
        Rarity.RARE,
        "перекрёсток без единого человека. Такого не бывает",
        season="лето",
        emoji="📸",
    ),
    Item(
        "netsuke_fox",
        "Нэцкэ-лисица из тёмного дерева",
        Rarity.RARE,
        "отполирована чьими-то пальцами до блеска",
        emoji="🦊",
    ),
    # --- легендарные (3) ---
    Item(
        ...
        "Письмо без адресата",
        Rarity.LEGENDARY,
        "запечатано. Я не вскрывала. Почти уверена, что не вскрывала",
        emoji="✉️",
    ),
    Item(
        "unknown_key",
        ...
        Rarity.LEGENDARY,
        "тяжёлый, латунный. Где-то в Токио есть его дверь",
        emoji="🗝️",
    ),
    Item(
        "tokyo_1987",
        "Фотография Токио 1987 года",
        Rarity.LEGENDARY,
        "город, которого больше нет, в идеальной сохранности",
        emoji="🏙️",
    ),
    # --- праздничные: существуют только в свой день (сезонные события) ---
    Item(
        "first_bell",
        "Колокольчик первого рассвета",
        Rarity.RARE,
